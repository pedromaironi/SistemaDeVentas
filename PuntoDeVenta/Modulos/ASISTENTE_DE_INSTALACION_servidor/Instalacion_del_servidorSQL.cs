...
namespace PuntoDeVenta.Modulos.ASISTENTE_DE_INSTALACION_servidor
{
    public partial class Instalacion_del_servidorSQL : Form
    {
        ...
        private void Instalacion_del_servidorSQL_Load(object sender, EventArgs e)
        {
            ...
            txtEliminarBase.Text = txtEliminarBase.Text.Replace("BASESISTEMA", TXTbasededatos.Text);
            txtCrear_procedimientos.Text = txtCrear_procedimientos.Text.Replace("BASESISTEMA", TXTbasededatos.Text);
